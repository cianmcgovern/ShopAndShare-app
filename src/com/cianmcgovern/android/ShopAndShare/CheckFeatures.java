...
public class CheckFeatures {
    ...
    public static boolean haveFlash() {
        return Constants.packageManager.hasSystemFeature(PackageManager.FEATURE_CAMERA_FLASH);
    }
    ...
    public static boolean haveAutoFocus() {
        return Constants.packageManager.hasSystemFeature(PackageManager.FEATURE_CAMERA_AUTOFOCUS);
    }
    ...
    public static boolean haveCamera() {
        return Constants.packageManager.hasSystemFeature(PackageManager.FEATURE_CAMERA);
    }
    ...
    public static boolean haveGPS() {
        return Constants.packageManager.hasSystemFeature(PackageManager.FEATURE_LOCATION_GPS);
    }
